...
import CreateProfileModal from './CreateProfileModal.jsx'; // <--- Import the Modal
...
const ProfilePage = () => {
    ...
    // Define fetchProfile outside useEffect so we can call it again after saving
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            ...
            <CreateProfileModal 
                ...
                onSuccess={fetchProfile} // This makes the page refresh automatically after save
            />
            ...
            {!profile ? (
                <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center">
                    <div className="max-w-lg w-full bg-white rounded-2xl shadow-lg p-8 text-center border border-gray-100">
                        ...
                        {/* CHANGED: Button opens modal instead of Link */}
                        <button 
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="px-8 pb-8">
                            <div className="relative flex justify-between items-end -mt-12 mb-6">
                                ...
                                {/* CHANGED: Edit button opens modal */}
                                <button 
                                    onClick={() => setIsModalOpen(true)}
